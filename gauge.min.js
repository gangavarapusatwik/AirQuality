(function () {
    ...
    ! function () {
        ...
        var i, e;
        for (t -= 3600 * (i = Math.floor(t / 3600)) + 60 * (e = Math.floor((t - 3600 * i) / 60)),
            t += "", e += ""; e.length < 2;) e = "0" + e;
        ...
        return m(i, t), i.prototype.displayedValue = 0, i.prototype.value = 0, i.prototype.setVal = function (t) {
            ...
            var t;// i have change this 
            return t = this.text ? u(this.displayedValue.toFixed(0)) : r(p(this.displayedValue)),
        ...
        function () {
            ...
            return m(i, t), i.prototype.lineWidth = 15, i.prototype.displayedValue = 0, i.prototype.value = 33, i.prototype.maxValue = 80, i.prototype.minValue = 0, i.prototype.options = {
                ...
                // i have change parseValue to origal value
